...
const intents: Intent[] = [
  ...
  {
    keys: /(интеграц|crm|api|подключа|мессенджер|телефон|почт)/i,
    reply:
      'Подключаемся к сайту, мессенджерам, почте и телефонии, синхронизируемся с популярными CRM и работаем через API. Заявки из всех каналов падают в одну ленту.',
    source: 'Интеграции',
