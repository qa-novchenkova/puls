...
const terms: { term: string; cat: Cat; def: string }[] = [
  ...
  { term: 'Воронка продаж', cat: 'Продажи', def: 'Путь клиента от первого интереса до оплаты, разбитый на этапы. Видно, где клиенты «отваливаются».' },
  { term: 'Конверсия', cat: 'Продажи', def: 'Доля тех, кто дошёл до нужного шага. Например, из 100 заявок купили 12 — конверсия 12%.' },
  { term: 'Follow-up', cat: 'Продажи', def: 'Повторный контакт с клиентом: напоминание, дожим, «как вам предложение?». Часто именно он приносит продажу.' },
